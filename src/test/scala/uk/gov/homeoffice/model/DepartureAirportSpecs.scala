...
class DepartureAirportSpecs extends Specification {

  "Departure Airport code" should {
    "give list of all airport for Greece" in {
      ...
      greeceList must containAllOf(expectedAirports)
    }

    "give list of all airport for Cyprus" in {
    ...
    "give list of all airport for Croatia" in {
    ...
    "give list of all airport for Slovenia" in {
    ...
    "give list of all airport for Bulgaria" in {
    ...
    "give list of all airport for Romania" in {
    ...
    "give list of all airport for Moldova" in {
